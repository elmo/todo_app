...
// 1. Define the Todo interface to match your Rails model
...
// 2. Props for the individual list item
...
const TodoItem: React.FC<TodoItemProps> = ({ todo, onToggle }): JSX.Element => (
  <li className="flex items-center mb-2 p-2 hover:bg-gray-50 rounded transition-colors">
    <input
      type="checkbox"
...
// 3. Props for the container list
